...
footer a {
    ...
    <body>
        <h2>Welcome to MiBell Comics Store</h2>
...
<!--			<button>Sign Up</button>-->
                        <button type="submit" value="Sign Up" id="SIGNUP" name="action">Sign Up</button>
		</form>
	</div>
	<div class="form-container sign-in-container">
		<form action="MainController" method="POST">
			...
			<a href="#">Forgot your password?</a>
                        <button type="submit" value="Sign In" id="SignIn" name="action">Sign In</button>
